...
const Home = () => {
  const projects = [
    ...
    },
    {
      ...
      imageUrl: "dist/messageImage_1734583260836.jpg",
    ...
    },
    {
      ...
      imageUrl: "dist/messageImage_1734584458965.jpg",
    ...
    },
    {
      ...
      imageUrl: "dist/Screenshot 2024-12-21 152651.png",
    ...
    },
    {
      ...
      imageUrl: "dist/27b7e0aa-d857-4420-b340-eb9d7234479a.jpg",
      link: "",
    },

    {
      ...
      imageUrl: "dist/455016141_1785362471874344_1637157699492110556_n.jpg",
      link: "",
    },
  ];
...
to help them identify areas for improvement"
            imageUrl="dist/9b9a822d-aa79-4e3c-9021-6930dee51383.jpg"
          />
        </div>
      </div>
